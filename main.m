...
pr2.animatePR2ArmsAndGripperswithMotionControl(Tb3r, bananaR, Tb3l, bananaL, numSteps, eStop);
pr2.animatePR2ArmsAndGripperswithMotionControl(bananaR, Tb3r, bananaL, Tb3l, numSteps, eStop);
